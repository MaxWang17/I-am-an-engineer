...
const packageOptions = pkg.buildOptions; // 自己在package.json中定义的选项 

// 对打包文件做一个映射表，然后根据你提供的formats来格式化打包的内容
const outputConfigs = { // 自定义
    'esm-bundler': {
    ...
    'global': {
        file: resolve(`dist/${name}.global.js`), // 全局的,立即执行函数
        format: 'iife'
    }
}
